...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(4323); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(6970);
...
const ruleset_1 = __webpack_require__(2757);
...
var configResolver = __webpack_require__(9201);
var core = __webpack_require__(7004);
var schema = __webpack_require__(6039);
...
var httpAuthSchemeProvider = __webpack_require__(9470);
var runtimeConfig = __webpack_require__(6199);
var regionConfigResolver = __webpack_require__(6869);
var protocolHttp = __webpack_require__(7922);
var schemas_0 = __webpack_require__(1437);
var errors = __webpack_require__(6065);
var SSOServiceException = __webpack_require__(3615);
...
const SSOServiceException_1 = __webpack_require__(3615);
...
const config_resolver_1 = __webpack_require__(9201);
...
const runtimeConfig_shared_1 = __webpack_require__(7364);
...
const util_utf8_1 = __webpack_require__(6559);
const httpAuthSchemeProvider_1 = __webpack_require__(9470);
const endpointResolver_1 = __webpack_require__(8731);
const schemas_0_1 = __webpack_require__(1437);
const getRuntimeConfig = (config) => {
    return {
...
const schema_1 = __webpack_require__(6039);
const errors_1 = __webpack_require__(6065);
const SSOServiceException_1 = __webpack_require__(3615);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 177).then(__webpack_require__.t.bind(__webpack_require__, 1177, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 177).then(__webpack_require__.t.bind(__webpack_require__, 1177, 23));
